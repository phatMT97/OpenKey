...
- **Loại trừ ứng dụng:** (On/Off) (Bản 2.1 về sau) - Cho phép loại trừ một số ứng dụng khỏi chế độ gõ tiếng Việt. Các ứng dụng trong danh sách loại trừ (như Command Prompt, Notepad++, IDE,...) sẽ luôn ở chế độ tiếng Anh, không thể chuyển sang tiếng Việt bằng phím tắt, tránh gõ nhầm tiếng Việt khi code hoặc làm việc với terminal.
